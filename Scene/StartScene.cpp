...
void StartScene::Initialize() {
    ...
    btn->SetOnClickCallback(std::bind(&StartScene::ScoreOnClick, this, 1));
    AddNewControlObject(btn);
    AddNewObject(new Engine::Label("Rank", "pirulen.ttf", 48, halfW, halfH / 2 + 130, 0, 0, 0, 255, 0.5, 0.5));
    ...
    btn = new Engine::ImageButton("stage-select/dirt.png", "stage-select/floor.png", halfW - 200, halfH / 2 + 320, 400, 100);
    btn->SetOnClickCallback(std::bind(&StartScene::SettingsOnClick, this, 2));
    AddNewControlObject(btn);
    AddNewObject(new Engine::Label("Settings", "pirulen.ttf", 48, halfW, halfH / 2 + 370, 0, 0, 0, 255, 0.5, 0.5));
}
...
void StartScene::ScoreOnClick(int stage) {
